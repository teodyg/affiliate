                        ...
                        <div className="padding-vertical padding-xxhuge">
                            <div className="max-width-large">
                                <div className="margin-bottom margin-small">
                                    <h1 data-text="tn922d316">Privacy policy</h1>
                                </div>
                                <div className="margin-bottom margin-small">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t7d8edc50">
                                        Automatic collection of information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t2399b16c">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t722af293">
                                        Collection of personal information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t42e6d4b3">
                                        ...
                                        name and email address). We receive and store any information you
                                        knowingly provide to us when you make a purchase, or fill any
                                        online forms on the Website. When required, this information may
                                        include the following:
                                    </p>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <ul role="list">
                                        <li data-text="t36ae36c7">
                                            Personal details such as name, country of residence, etc.
                                        </li>
                                        <li data-text="t3c80e907">
                                            Contact information such as email address, address, etc.
                                        </li>
                                        <li data-text="t42b03f0e">
                                ...
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn221e4076">
                                        ...
                                        take advantage of some of the features on the Website. Users who
                                        are uncertain about what information is mandatory are welcome to
                                        contact us.
                                    </p>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t57f07637">
                                        Use and processing of collected information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn6c3189d5">
                                ...
                                <div className="margin-bottom margin-small">
                                    <ul role="list">
                                        <li data-text="tn5b0c5286">Deliver products or services</li>
                                        <li data-text="tn56ac5905">Improve products and services</li>
                                        <li data-text="t1beb18b2">Send administrative information</li>
                                        <li data-text="tn38f353b6">
                                            Send marketing and promotional communications
                                        </li>
                                        <li data-text="t1d7af1ad">
                                            Respond to inquiries and offer support
                                        </li>
                                        <li data-text="tn5fd3bbb7">Request user feedback</li>
                                        <li data-text="tn745bffe9">Improve user experience</li>
                                        <li data-text="tn5c40b6aa">Post customer testimonials</li>
                                        <li data-text="tn29cb32d1">Deliver targeted advertising</li>
                                        <li data-text="t4dc79ea1">
                                            Enforce terms and conditions and policies
                                        </li>
                                        <li data-text="t13440c16">
                                            Protect from abuse and malicious users
                                        </li>
                                        <li data-text="tn6253ae00">
                                            Respond to legal requests and prevent harm
                                        </li>
                                        <li data-text="tn1aba26ab">
                                            Run and operate the Website and Services
                                        </li>
                                    </ul>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t57d24fc0">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t5c598fb">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t55e9aad6">
                                        Disclosure of information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t38acf0d7">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn37bd2e3b">
                                        Retention of information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn2e5ee532">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t274d5918">
                                        Transfer of information
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn70b1ff48">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t33c874d9">
                                        The rights of users
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn6ff67b2e">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn75c9e657">
                                        The right to object to processing
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn2cb77b61">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t2fb150df">
                                        Data protection rights under GDPR
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t700032bf">
                                        If you are a resident of the European Economic Area (EEA), you
                                        have certain data protection rights and Tax Rebate Specialists
                                ...
                                <div className="margin-bottom margin-small">
                                    <ul role="list">
                                        ...
                                        <li data-text="t2cc33814">
                                            You also have the right to withdraw your consent at any time
                                            where Tax Rebate Specialists relied on your consent to process
                                            your Personal Information.
                                        </li>
                                        <li data-text="tn51efadc4">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="teb597b7">
                                        California privacy rights
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn18f663a7">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn4b79aa99">
                                        How to exercise these rights
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t572a77f">
                                        Any requests to exercise your rights can be directed to Tax Rebate
                                        Specialists through the contact details provided in this document.
                                        Please note that we may ask you to verify your identity before
                                        responding to such requests. Your request must provide sufficient
                                        information that allows us to verify that you are the person you
                                        are claiming to be or that you are the authorized representative
                                        of such person. You must include sufficient details to allow us to
                                        properly understand the request and respond to it. We cannot
                                        respond to your request or provide you with Personal Information
                                        unless we first verify your identity or authority to make such a
                                        request and confirm that the Personal Information relates to you.
                                    </p>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn3bf2a290">
                                        Privacy of children
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t18c54679">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn64062591">
                                        Cookies
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                ...
                                <div className="margin-bottom margin-small">
                                    <p data-text="t7e26fe03">
                                        ...
                                        browser setting to decline cookies if you prefer. You may learn
                                        more about cookies and how they work in this guide.
                                    </p>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn605f8e0c">
                                        Do Not Track signals
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn29f61aab">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn285cc4d2">
                                        Advertisements
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn4cbe0bcf">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="td161e82">
                                        Email marketing
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tf189f2e">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn110a26a9">
                                        Links to other resources
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn7b084ca1">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn7a5dd82c">
                                        Information security
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn56ccdbbc">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tnda02c99">
                                        Data breach
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn50ad179a">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn47c90bf4">
                                        Changes and amendments
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="tn2a0c4451">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="tn6f8f830c">
                                        Acceptance of this policy
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t16c7f80">
                                ...
                                <div className="margin-bottom margin-small">
                                    <div className="heading-small" data-text="t799d079c">
                                        Contacting us
                                    </div>
                                </div>
                                <div className="margin-bottom margin-small">
                                    <p data-text="t13654cd7">
                                        ...
                                        email to&nbsp;
                                        <a href="mailto:support@TaxRebateSpecialists.com">
                                            support@TaxRebateSpecialists.com
                                        </a>
                                        .
                                    </p>
                                </div>
                                <div className="text-size-tiny" data-text="tn29795bb1">
                                    This document was last updated on May 28, 2022.
                                </div>
                            </div>
                        </div>
                    </div>
